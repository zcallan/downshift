  ...
  Downshift.prototype.componentDidMount = function componentDidMount() {
    ...
    /* istanbul ignore if (react-native) */
    {
      ...
      var onMouseUp = function (event) {
        ...
        var activeElementInDownshift = _this3._rootNode && isOrContainsNode(_this3._rootNode, _this3.props.environment.document.activeElement);
...
var _initialiseProps = function () {
  ...
  this.button_handleClick = function (event) {
    ...
    true && _this4.props.environment.document.activeElement === _this4.props.environment.document.body) {
      event.target.focus();
    }
  ...
  this.getInputProps = function () {
    ...
    if (rest.disabled) {
      ...
      eventHandlers = {
        onChange: composeEventHandlers(onChange, onInput, _this4.input_handleChange),
        onKeyDown: composeEventHandlers(onKeyDown, _this4.input_handleKeyDown),
        onBlur: composeEventHandlers(onBlur, _this4.input_handleBlur)
      };
    }
  ...
  this.getItemProps = function () {
    ...
    var onMouseMove = _ref6.onMouseMove,
        ...
        rest = objectWithoutProperties(_ref6, ['onMouseMove', 'onMouseDown', 'onClick', 'index', 'item']);
  ...
  this.reset = function () {
    ...
    otherStateToSet = pickState(otherStateToSet);
    _this4.internalSetState(function (_ref7) {
